var Skeleton = (function () {
    ...
    /**
     * @submodule Fire.Spine
     */
    /**
     * The main module of Spine, all classes, functions, properties and constants of Spine are defined in this
     * namespace.
     *
     * @module Fire.Spine
     * @main Fire.Spine
    ...
    var Skeleton = Fire.Class({
        name: 'Fire.Spine.Skeleton', extends: Renderer,
        ...
        getWorldSize: function () {
            return SpineRuntime.getWorldSize();
        },
    ...
    Fire.executeInEditMode(Skeleton);
